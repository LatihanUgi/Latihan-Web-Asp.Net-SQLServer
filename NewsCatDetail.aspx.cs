...
public partial class NewsCatDetail : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (idcat != null)
        {
            ...
            using (koneksi)
            {
                string sql = "select b.ID_Berita, c.NamaKategori, b.Tanggal, b.Judul, b.IsiBerita, b.Sumber, a.Nama, b.Foto from Berita b JOIN Kategori c on b.ID_Kategori = c.ID_Kategori JOIN Admin a on b.ID_Admin = a.ID_Admin where b.ID_Kategori = @id order by b.ID_Berita desc";
                SqlCommand sqlcom = new SqlCommand(sql, koneksi);
                using (sqlcom)
                {
                    sqlcom.Parameters.AddWithValue("@id", idcat);
