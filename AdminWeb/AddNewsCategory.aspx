<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddNewsCategory.aspx.cs" Inherits="AdminWeb_AddNewsCategory" %>
<script runat="server">
...
<head>
    ...
    <title>Add News Category | Administrator</title>
...
<div id="closed"></div>
<a href="#popup" class="popup-link">Klick To Add News Category</a>
<div class="popup-wrapper" id="popup">
 <div class="popup-container">
		<div class="popup-form">
                            <asp:TextBox ID="txtid" placeholder="ID Kategori.." runat="server" Width="250px" 
                                    CssClass="form-control" ontextchanged="txtid_TextChanged" disabled></asp:TextBox>
                        <br />
                            <asp:TextBox ID="txtKat" placeholder="News Category.." runat="server" Width="250px" CssClass="form-control"></asp:TextBox>
<asp:RequiredFieldValidator ID="RequiredFieldValidator1" ErrorMessage="Can not be empty!" ForeColor="Red" ControlToValidate="txtKat" runat="server" />
		...
		<a class="popup-close" href="#closed"><a class="popup-close" href="AddNewsCategory.aspx">X</a></a>
	</div>
</div>
                </div>
          </form>
                <div class="col-lg-4" style="margin-top:5px; margin-left:20px;">
            <h1>News Category Data</h1>
            <hr />
            <div>
            <asp:PlaceHolder ID="Datacat" runat="server"></asp:PlaceHolder>
            </div>
            <br />
