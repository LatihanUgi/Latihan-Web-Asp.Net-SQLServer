<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditDeleteNewsCategory.aspx.cs" Inherits="AdminWeb_EditDeleteNewsCategory" %>
...
<head>
    ...
    <title>Edit Delete News Category | Administrator</title>
                   ...
                   <li class="active">
                    ...
                    <li class="active">
                        ...
                        <ul id="catnews" class="collapse">
                            ...
                            <li class="active" style="background:#000;">
                                <a href="EditDeleteNewsCategory.aspx">Edit Delete News Category</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="col-lg-4">
                       <h4>
                            Update and Delete News Category
                        </h4>
                            <asp:TextBox ID="txtid" placeholder="ID Category.." runat="server" Width="250px" 
                                    CssClass="form-control" ReadOnly></asp:TextBox>
                        <br />
                            <asp:TextBox ID="txtKat" placeholder="News Category.." runat="server" Width="250px" CssClass="form-control"></asp:TextBox>
                           
                        <br />
                        <%--<asp:HiddenField runat="server" ID="txtId" />--%>
                        <asp:Button class="btn btn-default" id="simpanKat" runat="server" Text="Save" OnClick="simpanKat_Click"/>
                        <asp:Button class="btn btn-default" id="Reset" runat="server" Text="Cancel" OnClick="Reset_Click"/>
                        

                </div>
                <div class="col-lg-6" style="margin-top:5px; margin-left:20px;">
            <h3>News Category Data</h3>
            <hr />
            <div>
            <asp:GridView ID="gvDetail" runat="server" CssClass="table table-bordered" AllowPaging="true" 
            AutoGenerateColumns="false" Width="360px" OnSelectedIndexChanged="gvDetail_SelectedIndexChanged" DataKeyNames="ID_Kategori">
            <Columns>
            <asp:TemplateField HeaderText="ID Kategori">
                <ItemTemplate>
                    <asp:Label ID="lblID" Text='<%#Eval("ID_Kategori") %>' runat="server"/>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Nama Kategori">
                <ItemTemplate>
                    <asp:Label ID="lblNamaKat" Text='<%#Eval("NamaKategori") %>' runat="server"/>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Action">
                <ItemTemplate>
                    <asp:LinkButton ID="lnkRemove" CommandArgument='<%#Eval("ID_Kategori") %>' runat="server" OnClientClick="return confirm('Do You Want to Delete this Data?')"
